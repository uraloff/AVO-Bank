...
async def uz_bonuses(callback: CallbackQuery) -> None:
    ...
    await callback.message.answer_photo(photo=img.about_bonus_uz_photo,
                                        caption="<b>Bonuslar hisoblanishi:</b>\n• <b>Ilovani yuklab olish</b> va <b>AVO platinum</b> kartasini rasmiylashtirganlik uchun - 250 000 bonus\n• <b>«Do'stingizni taklif qilish»</b> aksiyasi - har bir do'st uchun — 50 000 bonus, do'stingizga — 250 000 bonus\n• <b>Tug'ilgan kun</b> sharafiga - 100 000 bonus\n• <b>Bir oy uchun</b> maksimal bonuslar summasi - 5 000 000 bonus\n\n<b>Bonuslardan foydalanish:</b>\n• <b>To'lovlar</b> va <b>Bank komissiyasi</b> uchun to'langan pulni qaytarish uchun bonuslardan foydalaning - 1 bonus = 1 so'm\n• Bonuslarni Bank komissiyasini to'lash uchun almashtirish - 100% gacha <i>(AVO platinum kartasiga xizmat ko'rsatish, pul yechib olish yoki pul o'tkazish xizmatlari uchun)</i>\n• Bonuslarni <b>boshqa to'lovlarni</b> to'lash uchun almashtirish - oyiga 50 000 bonus\n• Taqdim etilgan bonuslarning <b>amal qilish muddati</b> - 12 oy",
                                        reply_markup=inline_builder(
                                            ['Ortga qaytish ↩️'],
